...
def extract(split, infiles):
    ...
    img_features = h.create_dataset(
        'image_features', (num_boxes, 196, feature_length), 'f')
...
if __name__ == '__main__':
    ...
    infile = ['/media/ai-machine-1/dataset/VQA/Up-Down-Captioner/data/7w-features/train.tsv']
    extract('train', infile)

    infile = ['/media/ai-machine-1/dataset/VQA/Up-Down-Captioner/data/7w-features/val.tsv']
    extract('val', infile)

    infile = ['/media/ai-machine-1/dataset/VQA/Up-Down-Captioner/data/7w-features/test.tsv']
    extract('test', infile)
