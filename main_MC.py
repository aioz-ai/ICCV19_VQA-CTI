...
from dataset_MC import Dictionary, VQAFeatureDataset
import base_model_MC as base_model
from train_MC import train
import utils
...
def parse_args():
    ...
    # Choices of models
    parser.add_argument('--model', type=str, default='ban', choices=['ban', 'tan', 'learning_answer_embedding', \
                                                                     'create_teacher_model', 'pdban', 'stacked_attention', 'STL'],
    ...
    parser.add_argument('--teacher_file', default='teacher_logits_91.pkl', type=str, help='')
...
if __name__ == '__main__':
    ...
    val_dset = VQAFeatureDataset('val', args, dictionary, adaptive=True, max_boxes=args.max_boxes,
                                 question_len=args.question_len)
    if args.use_both:
        test_dset = VQAFeatureDataset('test2015', args, dictionary, adaptive=True, max_boxes=args.max_boxes,
                                      question_len=args.question_len)
