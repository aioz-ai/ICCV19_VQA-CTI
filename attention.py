...
class PDBiAttention(nn.Module):
    def __init__(self, v_dim, q_dim, h_dim, h_out, rank, glimpse, dropout=[.2,.5]):
        super(PDBiAttention, self).__init__()

        self.glimpse = glimpse
        self.logits = PDBCNet(v_dim, q_dim, h_dim, h_out, rank, glimpse, dropout=dropout, k=1)
